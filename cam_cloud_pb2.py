...
_QUERYPROGRESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='n_bytes_sent', full_name='camera.QueryProgress.n_bytes_sent', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mem_usage_percent', full_name='camera.QueryProgress.mem_usage_percent', index=8,
...
_DIVACAMERA = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetCamSpecs',
    full_name='camera.DivaCamera.GetCamSpecs',
    index=11,
    containing_service=None,
